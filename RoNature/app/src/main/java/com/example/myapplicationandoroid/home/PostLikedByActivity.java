...
import com.example.myapplicationandoroid.users.AdapterUsers;
import com.example.myapplicationandoroid.users.ModelUsers;
...
public class PostLikedByActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_likeby);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Post Loved by");
