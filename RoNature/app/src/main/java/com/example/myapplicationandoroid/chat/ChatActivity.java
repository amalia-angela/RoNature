package com.example.myapplicationandoroid.chat;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(v -> {
            Intent intent = new Intent(ChatActivity.this, UsersProfilActivity.class);
        ...
        userquery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    name.setText(nameh);
                    try {
                        Glide.with(ChatActivity.this).load(image).placeholder(R.drawable.ic_account_black).into(profile);
                    } catch (Exception e) {
