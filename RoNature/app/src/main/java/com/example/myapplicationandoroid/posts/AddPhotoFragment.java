package com.example.myapplicationandoroid.posts;
 ...
 */
public class AddPhotoFragment extends Fragment implements GoogleApiClient.OnConnectionFailedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title = view.findViewById(R.id.plocation);
...
//                .build();
//
//        mPlaceAutocompleteAdapter=new PlaceAutocompleteAdapter(getContext(),googleApiClient,LAT_LNG_BOUNDS, null);
//
//        title.setAdapter(mPlaceAutocompleteAdapter);
//
//        PlaceAutocompleteAdapter dataAdapter = new PlaceAutocompleteAdapter(AddPhotoFragment.this, R.layout.fragment_add_photo) {
//        title.setAdapter(dataAdapter);
//        title.setTextFilterEnabled(true);
                ...
                if (uriTask.isSuccessful()) {
                    ...
                    databaseReference.child(timestamp).setValue(hashMap)
                        ...
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(getContext(), "Failed updating data", Toast.LENGTH_LONG).show();
                        }
                    });
